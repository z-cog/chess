...
public class ChessPiece {
    ...
    /**
     * This function takes the following parameters, calculates legal moves, and adds them to an ArrayList.
     *
     ...
     * @param moves    A passed in array list of all moves generated by the function.
     */
    ...
    public Collection<ChessMove> pieceMoves(ChessBoard board, ChessPosition myPosition) {
        ...
        switch(this.type){
            ...
            case KNIGHT:
                ...
                endpos = null; //de-referencing, because why not?
                break;
